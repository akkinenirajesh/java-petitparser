...
public class Context {
	 ...
	 * The input buffer.
	 */
	protected final MultiLineStringBuffer buffer;
	 ...
	 */
	public Context(MultiLineStringBuffer buffer, int position) {
		this.buffer = buffer;
	 ...
	 */
	public MultiLineStringBuffer getBuffer() {
		return buffer;
	}
...
//	}
	 ...
	 */
	public Success success(Object value, int positionStart, int positionEnd) {
		return new Success(buffer, positionStart, positionEnd, value);
	}
	...
	public String toString() {
		int[] tuple = Token.lineAndColumnOf(buffer.getBuffer(), position);
